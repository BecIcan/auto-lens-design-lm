...
class RayInitialization:
    ...
    def __call__(
        ...
        **pupil_sampling_kwargs,
        ...
        # add by cjy: the zone table lives on the lens, so the edges are injected
...
# add by cjy: zone-aware pupil quadrature.  An annular surface makes the pupil
...
def mode_to_pupil_span(mode: str):
    ...
    return {
        ...
        "skew_uniform_zonal": skew_uniform_zonal,  # add by cjy
