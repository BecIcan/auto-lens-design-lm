...
class LMOptimizer(torch.optim.Optimizer):
    ...
    def step(self, closure):
        ...
        if (
            ...
            # Solve the linearized equalities first, then optimize in their null
            # space.  This is algebraically equivalent to the KKT step but avoids
            # squaring the condition number through J.T @ J.
